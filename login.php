...
#Modification log:     
                       9/18/2020 -- Reconstructed entire project; CSS now runs properly
                                    Created login php page for admin 
                                    9/18/2020 -- Reconstructed entire project; CSS now runs properly
 --
------------------------------------------------------------------------------------------------------------------>
<!DOCTYPE html>
...
<body>
        ...
        <div class="container"><a class="navbar-brand logo" href="#">Tabatha Foes</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navbarNav"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="hire-me.html">Contact</a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="admin.php">Admin</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <div class="contact-clean">
        <form method="post" action="admin.php">
            ...
            <div class="form-group"><input class="form-control is-invalid" type="text" name="username"   required><small class="form-text text-danger">Please enter your username.</small></div>
            <div class="form-group"><input class="form-control is-invalid" type="text" name="username"  required><small class="form-text text-danger">Please enter a correct email address.</small></div>
            <div class="form-group"><button class="btn btn-primary" type="submit">Sign In </button></div>
        </form>
    </div>
